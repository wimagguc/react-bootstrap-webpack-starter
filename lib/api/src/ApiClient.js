...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DemoApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://demo-api.herokuapp.com/api/v1
     */
    this.basePath = 'https://demo-api.herokuapp.com/api/v1'.replace(/\/+$/, '');
